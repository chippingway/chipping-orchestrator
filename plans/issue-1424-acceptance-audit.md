...
current working implementation removes 116 pairs and leaves 13 pairs across 10 paths. Its remaining
13 production pairs and zero test pairs all match isolated diagnostics, with no stale or unmapped pair.
