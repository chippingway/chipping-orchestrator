...
current working implementation removes 100 pairs and leaves 29 pairs across 25 paths. Its remaining
29 production pairs and zero test pairs all match isolated diagnostics, with no stale or unmapped pair.
