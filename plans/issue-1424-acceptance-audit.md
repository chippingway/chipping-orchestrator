...
current working implementation removes 45 pairs and leaves 84 pairs across 70 paths. Its remaining
57 production pairs and 27 test pairs all match isolated diagnostics, with no stale or unmapped pair.
