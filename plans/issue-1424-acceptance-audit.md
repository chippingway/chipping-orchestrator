...
current working implementation removes 125 pairs and leaves 4 pairs across 3 paths. Its remaining
4 production pairs and zero test pairs all match isolated diagnostics, with no stale or unmapped pair.
