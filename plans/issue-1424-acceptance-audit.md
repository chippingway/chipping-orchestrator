...
current working implementation removes 84 pairs and leaves 45 pairs across 41 paths. Its remaining
45 production pairs and zero test pairs all match isolated diagnostics, with no stale or unmapped pair.
