...
current working implementation removes 102 pairs and leaves 27 pairs across 23 paths. Its remaining
27 production pairs and zero test pairs all match isolated diagnostics, with no stale or unmapped pair.
