...
current working implementation removes 80 pairs and leaves 49 pairs across 44 paths. Its remaining
49 production pairs and zero test pairs all match isolated diagnostics, with no stale or unmapped pair.
