...
current working implementation removes 87 pairs and leaves 42 pairs across 38 paths. Its remaining
42 production pairs and zero test pairs all match isolated diagnostics, with no stale or unmapped pair.
