...
current working implementation removes 42 pairs and leaves 87 pairs across 73 paths. Its remaining
60 production pairs and 27 test pairs all match isolated diagnostics, with no stale or unmapped pair.
