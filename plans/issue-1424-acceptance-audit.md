...
current working implementation removes 122 pairs and leaves 7 pairs across 5 paths. Its remaining
7 production pairs and zero test pairs all match isolated diagnostics, with no stale or unmapped pair.
