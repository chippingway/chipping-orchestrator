...
current working implementation removes 118 pairs and leaves 11 pairs across 9 paths. Its remaining
11 production pairs and zero test pairs all match isolated diagnostics, with no stale or unmapped pair.
