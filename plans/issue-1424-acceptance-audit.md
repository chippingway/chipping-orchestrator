...
current working implementation removes 109 pairs and leaves 20 pairs across 16 paths. Its remaining
20 production pairs and zero test pairs all match isolated diagnostics, with no stale or unmapped pair.
