...
current working implementation removes 90 pairs and leaves 39 pairs across 35 paths. Its remaining
39 production pairs and zero test pairs all match isolated diagnostics, with no stale or unmapped pair.
