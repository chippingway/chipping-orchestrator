...
current working implementation removes 93 pairs and leaves 36 pairs across 32 paths. Its remaining
36 production pairs and zero test pairs all match isolated diagnostics, with no stale or unmapped pair.
