...
current working implementation removes 121 pairs and leaves 8 pairs across 6 paths. Its remaining
8 production pairs and zero test pairs all match isolated diagnostics, with no stale or unmapped pair.
