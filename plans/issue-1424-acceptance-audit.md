...
current working implementation removes 115 pairs and leaves 14 pairs across 11 paths. Its remaining
14 production pairs and zero test pairs all match isolated diagnostics, with no stale or unmapped pair.
