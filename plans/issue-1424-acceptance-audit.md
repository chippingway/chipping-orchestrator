...
current working implementation removes 97 pairs and leaves 32 pairs across 28 paths. Its remaining
32 production pairs and zero test pairs all match isolated diagnostics, with no stale or unmapped pair.
