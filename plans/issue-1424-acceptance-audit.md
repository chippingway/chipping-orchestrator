...
current working implementation removes 55 pairs and leaves 74 pairs across 63 paths. Its remaining
57 production pairs and 17 test pairs all match isolated diagnostics, with no stale or unmapped pair.
