...
current working implementation removes 113 pairs and leaves 16 pairs across 13 paths. Its remaining
16 production pairs and zero test pairs all match isolated diagnostics, with no stale or unmapped pair.
