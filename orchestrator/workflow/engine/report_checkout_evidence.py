...
Asked first of the three groups because it costs no request and answers the
...
def checkout_verdict(
    ...
    whichever host made it, and the stage behind this has its own answer for an
    issue whose checkout is absent. A tree that would not report its state
    holds, since nobody could say anything about it at all.
    """
