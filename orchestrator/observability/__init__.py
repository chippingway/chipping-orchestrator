...
Every initializer is a marker that imports no owner and declares no
``__all__``. Callers import parsers, result types, and recorders from their
defining modules, and patches target those same owners. Nothing under the
tree carries an export manifest or a resolver hook.
