...
# closes the issue, in GitHub's words rather than this workflow's, and the line
# beneath names the session whose branch this is. Nothing was going to rewrite
# it, so a report verified on it costs the publication nothing.
NAMED_DESCRIPTION = "\n\n".join((
    "### Report",
    "The branch adds the thing. Verified by hand.",
    f"Fixes #{support.REPORT_ISSUE}",
    (
