...
class LateSplitCase:
    ...
    def _transact(
        ...
        **state,
        ...
        with snapshot_seams(snapshot or SnapshotSeed()) as teardown:
...
def child_marker(generation, index: int) -> str:
    """The receipt this generation's slice `index` is stamped with.
